...
void detectar_personaje(char *personaje_detectado, char personaje_1, char personaje_2,int diferencia_personaje_1, int diferencia_personaje_2){
...
void mostrar_resultados(char personaje_detectado){
    ...
    else if(personaje_detectado == JOHNNY_BRAVO){
...
int main(){
    char sabor;
    char color;
    char personaje_1, personaje_2, personaje_detectado;
    ...
    detectar_personaje(&personaje_detectado, personaje_1, personaje_2, diferencia_personaje_1, diferencia_personaje_2);

    mostrar_resultados(personaje_detectado);
